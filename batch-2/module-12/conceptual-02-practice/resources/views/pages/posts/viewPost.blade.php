                            ...
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    <div class="blog-thumb">
                                        <img src="{{ asset('images/post_image/' . $viewPost->featured_image) }}"
                                            alt="">
                                    </div>
                                    <div class="down-content">
                                        <span> {{ $viewPost->category->categoryName }} </span>
                                        <h4> {{ $viewPost->title }} </h4>
                                        <ul class="post-info">
                                            <li> Codearif </li>
                                            <li> {{ $viewPost->created_at->diffForHumans() }} </li>
                                            <li>  </li>
                                        </ul>
                                        <p> {{ $viewPost->description }} </p>
                                        <div class="post-options" style="text-align: center">
                                            <strong>----CODEARIF----</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
